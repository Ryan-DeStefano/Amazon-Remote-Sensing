...
n_pts_per_polygon <- c(5, 10, 15, 8, 12)  # Example vector, replace with your desired values
...
# Loop through each region to sample points
for (i in 1:length(n_pts_per_polygon)) {
  # Sample points from the i-th polygon
...
```{r}
lsat.dt <- do.call("rbind", lapply(c("Correct_Days_Top_10_Brazil.csv"), fread))
```
