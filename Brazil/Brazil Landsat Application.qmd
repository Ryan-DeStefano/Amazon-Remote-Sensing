...
n_pts_per_polygon <- num_sample_points(top_10_para)  # Example vector, replace with your desired values
...
```{r}
lsat.dt <- do.call("rbind", lapply(c("C:/Users/Ryman/Downloads/lsatTS_export_chunk_1 (1).csv"), fread))
```
